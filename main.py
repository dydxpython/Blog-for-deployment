...
ckeditor = CKEditor(app) # Initialise the CKEditor so that you can use it in make_post.html
Bootstrap5(app)
...
#Use https://flask-gravatar.readthedocs.io/en/latest/ to add Gravatar images into your comments section. 
#Hint: Check out this page for more detailed info: https://docs.gravatar.com/
...
# CONFIGURE TABLES
#create a bidirectional One-to-Many relationship between the two tables. The User should be the parent and the BlogPost will be child. You should be able to easily locate the BlogPosts a User has written and also the User of any BlogPost object.
...
def register():
    ...
    if form.validate_on_submit():
        ...
        # Holen der Formulardaten und Erstellen eines neuen Benutzers:
        new_user = User(
        ...
        return redirect(url_for("get_all_posts")) #Weiterleitung zur get_all_posts Seite
...
def login():
    ...
    if form.validate_on_submit():
        ...
        # Password incorrect
            ...
            return redirect(url_for('login'))
        else: #  stored password hash = entered password hash.
            login_user(user)
